CLASS zrap100_gen_data_JU DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap100_gen_data_JU IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '_JU',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav_JU.

    "insert travel demo data
    INSERT zrap100_atrav_JU  FROM (
        SELECT
